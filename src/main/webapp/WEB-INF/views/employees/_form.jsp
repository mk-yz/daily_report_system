...
<%@ page import="constans.AttributeConst" %>
<%@ page import="constans.ForwardConst" %>
...
<input type="password" name="${AttributeConst.EMP_PASS.getValue()}" id="${AttributeConst.EMP_NAME.getValue()}" value="${employee.name}" />
<br/><br/>
