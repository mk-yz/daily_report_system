...
import constans.AttributeConst;
import constans.ForwardConst;
import constans.JpaConst;
import constans.MessageConst;
import constans.PropertyConst;
...
public class EmployeeAction extends ActionBase {
    ...
    /**
     * ログイン中の従業員かどうかチェックし、管理者でなければエラー画面を表示
